...
public class Efiling {
	...
	public static void main(String[] args) throws Exception {
		//'captchaImg'  captcha image element id
		Response resp =  Jsoup.connect("https://portal.incometaxindiaefiling.gov.in/e-Filing/UserLogin/LoginHome.html").ignoreContentType(true).execute();
		System.out.println(resp.body());
		
		Document document = resp.parse();
		System.out.println(document.getElementById("captchaImg").attr("src"));
